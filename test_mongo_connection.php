<?php
// Command line script to test MongoDB connection

require_once __DIR__ . '/workspace/vendor/autoload.php';
...
try {
    $config = include(__DIR__ . '/workspace/api/config/db_config.php');
